...
var featuredJSON = {
	...
	"COL":{
		...
		"year":1985,
		"options":["Story"],
		"Story":[{"Button":"Catastrophic Eruption Destroys Town, Leads to Volcano Disaster Assistance Program","Name":"col.html"}],
		"Video":[],
		"Infographic":[],
		"type":"volcano",
		"fullname":"Colombia",
	...
	"JAM":{
		...
		"year":2004,		
		"options":["Story"],		
		"Story":[{"Button":"Guiding America's Compassionate Spirit: Hurricane Gilbert and the Formation of the Center for International Disaster Infromation","Name":"jam.html"}],
		"Video":[],
		"Infographic":[],
		"type":"storm",
		"fullname":"Jamaica",
	...
	"io_tsunami":{
		...
		"options":["Story"],
		"region_type":"tsunami",
		"Story":[{"Button":"Snapshots of Hope in the Indian Ocean Tsunami Response","Name":"io_tsunami.html"},{"Button":"Providing Relief in Sri Lanka After Devastating Tsunami ","Name":"io_tsunami2.html"}],
		"Infographic":[],
		"Video":[],
